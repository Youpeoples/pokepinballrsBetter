...
void RunBallCaptureSequence(void)
{
    ...
    case 12:
        ...
        gCurrentPinballGame->captureAngleQ16 -= (temp_r0 * 0x2000) / 100 - 0x2000;
        ...
        {
            s32 var_3 = (gCurrentPinballGame->catchSpinRadius * temp_r0) / 80;

            gCurrentPinballGame->ball->positionQ8.x =
                (gCurrentPinballGame->catchTargetX << 8) + Cos(gCurrentPinballGame->captureAngleQ16) * var_3 / 20000;
            gCurrentPinballGame->ball->positionQ8.y =
                (gCurrentPinballGame->catchTargetY << 8) - Sin(gCurrentPinballGame->captureAngleQ16) * var_3 / 20000;
        }
        break;
    ...
    case 30:
        ...
        gCurrentPinballGame->captureAngleQ16 = 0;
        break;
