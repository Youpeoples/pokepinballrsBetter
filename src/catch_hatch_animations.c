...
void InitAreaRoulette(void)
{
    ...
    gCurrentPinballGame->rouletteSpeciesId[1] = gAreaToSpeciesTable[gCurrentPinballGame->area];
...
void UpdateAreaRoulette(void)
{
    ...
    case 5:
        ...
        if (gCurrentPinballGame->rouletteFrameIndex == 0)
        {
            gCurrentPinballGame->rouletteSpeciesId[0] = gCurrentPinballGame->rouletteSpeciesId[1];
            LoadPortraitGraphics(0, 0);
        }
