...
struct PinballGame
{
    ...
    /*0x306*/ s8 pelliperState;
    /*0x307*/ s8 pelliperSwallowAnimIndex;
    /*0x308*/ u16 bumperHitsSinceReset;
    /*0x30A*/ u16 pelliperSwallowSubTimer;
    /*0x30C*/ u16 pelliperFrameTimer;
    /*0x30E*/ s16 pelliperYBobOffset;
    /*0x310*/ s16 pelliperSfxTimer;
    /*0x312*/ u8 filler312[0x2];
    /*0x314*/ s16 pelliperBallDropVelX;
    /*0x316*/ s16 pelliperBallDropVelY;
    /*0x318*/ s16 pelliperBallDropPosX;
    /*0x31A*/ s16 pelliperBallDropPosY;
    /*0x31C*/ s16 pelliperFlyVelX;
    /*0x31E*/ s16 pelliperFlyVelY;
    /*0x320*/ s16 pelliperPosX;
    /*0x322*/ s16 pelliperPosY;
    ...
    /*0x60B*/ s8 unk60B;
    /*0x60C*/ s16 travelPelliperPosX;
    /*0x60E*/ s16 travelPelliperPosY;
    /*0x610*/ u16 travelPelliperVelX;
    /*0x612*/ u16 travelPelliperVelY;
